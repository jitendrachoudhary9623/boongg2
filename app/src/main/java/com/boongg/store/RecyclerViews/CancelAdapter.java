...
public class CancelAdapter extends RecyclerView.Adapter<CancelAdapter.CancelViewHolder> {
    ...
    List<Cancel> bookings;
    Context mContext;

    public CancelAdapter() {
    }

    public CancelAdapter(List<Cancel> bookings, Context context) {
        this.bookings = bookings;
        mContext = context;
    }

    @Override
    public CancelViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mContext).inflate(R.layout.rv_cancel, parent, false);
        CancelViewHolder mv = new CancelViewHolder(itemView);
        return mv;
    }
    ...
    public class CancelViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindData(final int position) {
            final Cancel booking=bookings.get(position);
