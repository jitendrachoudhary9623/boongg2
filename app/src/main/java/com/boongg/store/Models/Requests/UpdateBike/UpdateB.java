...
package com.boongg.store.Models.Requests.UpdateBike;
...
public class UpdateB implements Parcelable
{
    ...
    @Expose
    private String id;
    public final static Creator<UpdateB> CREATOR = new Creator<UpdateB>() {


        @SuppressWarnings({
            "unchecked"
        })
        public UpdateB createFromParcel(Parcel in) {
            return new UpdateB(in);
        }

        public UpdateB[] newArray(int size) {
            return (new UpdateB[size]);
        }

    }
    ;

    protected UpdateB(Parcel in) {
