...
public class PreDropBooking implements Parcelable
{
    ...
    @Expose
    private com.boongg.store.Models.Responses.PreDropBookings._webuserId _webuserId;
    @SerializedName("_rentBikeKey")
    @Expose
    private com.boongg.store.Models.Responses.PreDropBookings._rentBikeKey _rentBikeKey;
    ...
    @Expose
    private com.boongg.store.Models.Responses.PreDropBookings._rentPoolKey _rentPoolKey;
    ...
    public final static Parcelable.Creator<PreDropBooking> CREATOR = new Creator<PreDropBooking>() {
        ...
        public PreDropBooking createFromParcel(Parcel in) {
            return new PreDropBooking(in);
        }

        public PreDropBooking[] newArray(int size) {
            return (new PreDropBooking[size]);
        }

    }
    ;

    protected PreDropBooking(Parcel in) {
        ...
        this._webuserId = ((com.boongg.store.Models.Responses.PreDropBookings._webuserId) in.readValue((_webuserId.class.getClassLoader())));
        this._rentBikeKey = ((com.boongg.store.Models.Responses.PreDropBookings._rentBikeKey) in.readValue((_rentBikeKey.class.getClassLoader())));
        ...
        this._rentPoolKey = ((com.boongg.store.Models.Responses.PreDropBookings._rentPoolKey) in.readValue((_rentPoolKey.class.getClassLoader())));
    ...
    public com.boongg.store.Models.Responses.PreDropBookings._webuserId get_webuserId() {
        return _webuserId;
    }

    public void set_webuserId(com.boongg.store.Models.Responses.PreDropBookings._webuserId _webuserId) {
        this._webuserId = _webuserId;
    }

    public com.boongg.store.Models.Responses.PreDropBookings._rentBikeKey get_rentBikeKey() {
        return _rentBikeKey;
    }

    public void set_rentBikeKey(com.boongg.store.Models.Responses.PreDropBookings._rentBikeKey _rentBikeKey) {
    ...
    public com.boongg.store.Models.Responses.PreDropBookings._rentPoolKey get_rentPoolKey() {
        return _rentPoolKey;
    }

    public void set_rentPoolKey(com.boongg.store.Models.Responses.PreDropBookings._rentPoolKey _rentPoolKey) {
