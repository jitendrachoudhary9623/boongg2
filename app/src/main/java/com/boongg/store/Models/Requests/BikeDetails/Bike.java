...
package com.boongg.store.Models.Requests.BikeDetails;
...
public class Bike implements Parcelable
{
    ...
    @Expose
    private String id;
    public final static Creator<Bike> CREATOR = new Creator<Bike>() {
    ...
    protected Bike(Parcel in) {
        ...
        in.readList(this.owner, (com.boongg.store.Models.Requests.BikeDetails.Owner.class.getClassLoader()));
