...
public class PriceChart implements Parcelable
{
    ...
    public String toString() {
        return "PriceChart{" +
                ...
                ", threeDayRate=" + threeDayRate +
                ", fourDayRate=" + fourDayRate +
                ", fiveDayRate=" + fiveDayRate +
                ", sixDayRate=" + sixDayRate +
                ", sevenDayRate=" + sevenDayRate +
                ", tenDayRate=" + tenDayRate +
                ", twentyDayRate=" + twentyDayRate +
                ", isAdminRentApplied=" + isAdminRentApplied +
                '}';
    }
